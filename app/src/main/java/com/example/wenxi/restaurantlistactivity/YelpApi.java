...
public class YelpApi {
    ...
    private static final String CONSUMER_KEY = "NSbVIPIyX2y_LdZv7GLtpQ";
    private static final String CONSUMER_SECRET = "6oTMEoX6ActYoO97yEfcAse3DKw";
    private static final String TOKEN = "h23SgK0RE5a9wbw8lYQKsfNq45xiEbVd";
    private static final String TOKEN_SECRET = "9UcTjxJve0wgqJBTxEYeBXj1n_I";
